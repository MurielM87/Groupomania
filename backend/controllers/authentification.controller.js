...
exports.deleteProfil = (req, res) => {
    ...
    DBconnection.query('DELETE FROM user WHERE id = :id', { replacements: { id: req.body.user_id }, type: DBconnection.QueryTypes.DELETE })
        .then(() => {
            //delete the data with the user_id
            DBconnection.query('DELETE FROM post WHERE user_id = :user_id', { replacements: { userId: parseInt(req.body.user_id) }, type: DBconnection.QueryTypes.DELETE })
